...
function revealAnswer_4() {
    document.getElementById("hiddenAnswer4").style.display = "block"
}

function revealAnswer_5() {
    document.getElementById("hiddenAnswer5").style.display = "block"
}

function revealAnswer_6() {
    document.getElementById("hiddenAnswer5").style.display = "block"
}
