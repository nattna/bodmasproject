...
function revealAnswer_13() {
    document.getElementById("hiddenAnswer13").style.display = "block"
}

function revealAnswer_14() {
    document.getElementById("hiddenAnswer14").style.display = "block"
}

function revealAnswer_15() {
    document.getElementById("hiddenAnswer15").style.display = "block"
}
